const en = {
  ...
  'generic.alert.success.title': {
    id: 'generic.alert.success.title',
    defaultMessage: 'Successfully saved',
    description: 'Title inside the component Alert.',
  },
  'generic.alert.success.description': {
    id: 'generic.alert.success.description',
    defaultMessage: 'Your changes have been successfully saved. You can continue working or close this page safely.',
    description: 'Description inside the successfully Alert component.',
  },
  'generic.alert.danger.title': {
    id: 'generic.alert.danger.title',
    defaultMessage: 'Error occurred',
    description: 'Title inside the danger Alert component.',
  },
  'generic.alert.danger.description': {
