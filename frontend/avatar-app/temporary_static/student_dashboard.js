$(document).ready(function () {
    ...
    let choiceSubjectMarathonButton = $('#choiceSubjectMarathonButton');
    let choiceSubjectMarathonModal = $('#choiceSubjectMarathonModal');
    let marathonSubjectTimers = $('.marathonSubjectTimer');
    let marathonDetailLink = $('#marathonDetailLink');
    ...
    closeTimerButton.click(function () {
    ...
    $('#onboardingBtn').click(function (e) {
        e.preventDefault();
    ...
    if (choiceSubjectMarathonButton) {
        let choiceSubject = $('.choiceSubject');
        choiceSubjectMarathonButton.on('click', function (e) {
            choiceSubjectMarathonModal.css("display", "flex");
        });
        $('#undoChoiceSubjectMarathon').on("click", function (e) {
            choiceSubjectMarathonModal.css("display", "none");
        });

        $('#submitChoiceSubjectMarathon').on('click', function (e) {
            let selectedSubject = choiceSubject.filter(':checked');
            let data = {'chosen_marathon_subject': selectedSubject.val()}
            $.ajax({
                ...
                error: function (response) {
                    let error_message = Object.values(response.responseJSON)[0];
    ...
    marathonSubjectTimers.each( function() {
        ...
        let endTime = moment(timerElement.data('endTime'));
    ...
    if (showMarathonContractInfoButton) {
        showMarathonContractInfoButton.on('click', function () {
    ...
    let subTabParam = urlParams.get('sub-tab');
    if (subTabParam) {
    ...
    $('#onboardingModalClose').on('click', function () {
